...
**Швидке прикріплення через `#`** — введіть `#` у полі чату, з'явиться попап з вашими налаштованими SSH-серверами. Оберіть потрібний — він прикріпиться як чіп, і Claude знатиме, що команди треба виконувати на тій машині. Без перемикання контексту, без кліків по сайдбару — просто `#` і вперед.
