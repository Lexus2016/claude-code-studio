...
> **v5.69.0** — Модель **Fable** знову доступна в усіх перемикачах моделі — веб-чат (панель і мобільне меню), Kanban (форми ланцюга і задачі) та Планувальник. У нещодавній збірці її було приховано — тепер вона повернена скрізь, де обирається модель.
