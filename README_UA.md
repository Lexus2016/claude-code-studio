...
> **v5.57.0** — Натисніть **`T`** для переходу до першого повідомлення; **`N`** — новий чат; клавіатурна навігація тепер охоплює повний цикл роботи із сесіями без жодного кліку мишею.
