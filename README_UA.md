...
> **v5.67.0** — Прохід шліфування інтерфейсу: плавніші переходи станів і наведення по всьому застосунку, явний курсор-вказівник на кожному інтерактивному елементі, лічильники з табличними цифрами без «стрибків» під час зміни, збалансоване перенесення тексту в заголовках і абзацах, чіткіше згладжування шрифтів.
