...
- `/diff` — точно виліть що змінилось в останньому коміті
...
Напишіть повідомлення Claude прямо з Telegram. Він стрімить відповідь одночасно на ваш телефон І на браузер. Розмова єдина — продовжуйте в Telegram, підберіть на ноутбуці через 5 хвилин, все там.

**Парування на Кількох Пристроях**
Підпаруйте телефон, планшет, ноутбук — все одразу. Керуйте одним екземпляром Claude Code Studio звідкись завгодно. Кожен пристрій отримує сповіщення коли задачи готові, з кнопками: [Показати] [Продовжити] [Меню].
...
| 📱 Telegram-бот | Керуйте Claude з телефону — сповіщення, команди, трансляція сесії |
| 🔔 Push-сповіщення | Задача готова? Отримайте сповіщення з кнопками [Показати] [Продовжити] |
| 📡 Трансляція сесії | Пишіть в Telegram, відповіді стримляються на обидві пристрої одночасно |
