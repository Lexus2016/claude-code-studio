...
> **v5.63.0** — Catch-up із термінала: підтягніть розмову `claude --resume` просто у вебчат. Чистіший хедер — статус CLI тепер одна зелена/червона крапка з'єднання. Панель Keyboard Shortcuts повністю локалізовано (EN/UA/RU).
