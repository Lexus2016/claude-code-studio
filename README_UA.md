...
> **v5.70.1** — До мов інтерфейсу додано **французьку та іврит**, тепер їх п'ять (EN/UA/RU/FR/HE). Перекладено кожен рядок у веб-застосунку та Telegram-боті. Іврит отримав повну підтримку письма справа наліво: розкладка, аватари повідомлень, кнопки дій, таблиці, списки та виноски дзеркаляться, тоді як блоки коду й вбудовані команди лишаються зліва направо, а кожне повідомлення саме визначає свій напрям — тож змішані відповіді іврит/англійська читаються правильно.
