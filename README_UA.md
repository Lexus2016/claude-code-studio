...
- **Не форк Claude Code** — обгортає офіційний CLI/SDK. Коли Anthropic випускає оновлення, ви отримуєте їх автоматично.
...
- **АБО** Anthropic API ключ — використовуйте SDK engine, підписка CLI не потрібна
