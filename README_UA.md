...
> **v5.68.0** — Живий індикатор активності у веб-чаті: у потоковій відповіді тепер видно, що робить Claude — «Думаю…», «Виконую: <інструмент>…», «Генерую…» — з живим лічильником часу в підвалі повідомлення, тож завжди зрозуміло, що робота триває і скільки вже. Включає виправлення: таймер більше не «витікає» при закритті вкладки чи зміні сесії під час відповіді.
