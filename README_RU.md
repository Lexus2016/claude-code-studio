...
> **v5.54.0** — Справочник горячих клавиш (`?`), счётчик сообщений в панели сессии и более чёткий обзор состояния сессии.
