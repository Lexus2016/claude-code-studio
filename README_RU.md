...
- **Не форк Claude Code** — оборачивает официальный CLI/SDK. Когда Anthropic выпускает обновления, вы получаете их автоматически.
...
- **ИЛИ** Anthropic API ключ — используйте SDK engine, подписка CLI не нужна
