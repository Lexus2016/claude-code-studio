...
| 🔌 SDK Mode | Через API ключ Anthropic (оплата за токены) |
...
|---|---|---|
| Оплата | Max подписка | За токены |
| Восстановление сессий | `--resume <id>` | SDK session |
| Стриминг | Парсинг stdout JSON | Нативный |
| Стабильность | Зависит от версии CLI | Стабильный |
| Мульти-Агент | ✅ | ✅ |
