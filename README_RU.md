...
> **v7.2.1** — **Исправлены два мультивкладочных бага.** Интерактивные терминальные сессии с кириллицей/UTF-8 больше не показывают "кракозябры" после респавна сессии. Полоска "кто печатает" над полем ввода в мульти-бот режиме больше не протекает между разными вкладками и проектами — переключение вкладок теперь корректно восстанавливает состояние каждой из них.
