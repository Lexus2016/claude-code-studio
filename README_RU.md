...
> **v5.69.0** — Модель **Fable** снова доступна во всех переключателях модели — веб-чат (панель и мобильное меню), Kanban (формы цепочки и задачи) и Планировщик. В недавней сборке её скрыли — теперь она возвращена везде, где выбирается модель.
