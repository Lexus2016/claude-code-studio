...
> **v7.1.2** — **Терминалы не дёргаются при переключении вкладок.** Каждая терминальная вкладка держит свою живую сессию, поэтому переход между ними больше ничего не переподключает и не перерисовывает, а история прокрутки сохраняется. Также исправлены оба новых диалога: нормальная шапка и кнопка закрытия, более крупные элементы выбора, чипы шаблонов больше не белые, появился пикер эмодзи для аватара бота, а плейсхолдеры больше не остаются украинскими в другом языке.
