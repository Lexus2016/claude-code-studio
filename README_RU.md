...
> **v7.2.2** — **Вопросы Claude больше не исчезают из чата.** Когда CLI обращался к своему встроенному инструменту вопросов, сообщение записывалось в историю, но не уходило в браузер — в чате оставался молчаливый пропуск на месте вопроса. Теперь оно отображается обычной строкой инструмента с текстом вопроса и вариантами ответа. Строка информационная — в headless-режиме stdin закрыт, нажимать там нечего.
