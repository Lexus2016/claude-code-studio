...
- Ваш телефон гудит когда каждая задача готова. Нажмите уведомление — видите что Claude построил.
...
- `/tunnel` — включайте и выключайте Remote Access прямо с телефона
...
Напишите сообщение Claude прямо из Telegram. Вы видите индикатор набора в реальном времени пока Claude думает, а ответ стримится одновременно на ваш телефон И в браузер. Разговор един — продолжите в Telegram, подберите на ноутбуке через 5 минут, всё там.
