...
> **v5.57.0** — Нажмите **`T`** для перехода к первому сообщению; **`N`** — новый чат; клавиатурная навигация теперь охватывает полный цикл работы с сессиями без единого клика мышью.
