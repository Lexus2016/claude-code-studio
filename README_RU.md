...
> **v5.55.0** — Экспорт чата в Markdown, клавиша `G` для перехода к последнему сообщению и портативный формат для любого ИИ или документа.
...
| **Движки** | API (фоновый `claude -p`, биллинг за токены) + Subscription (Claude Max tmux, без API-кредитов), подсказки движка, бейдж ⚡ Max, выбор модели Fable / Opus / Sonnet / Haiku |
