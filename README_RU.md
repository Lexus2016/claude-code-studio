...
> **v7.1.1** — **Боты и терминальные агенты.** Создавайте именованных AI-специалистов со своим промптом, моделью и памятью и зовите нескольких в один чат через `@@handle` — в браузере, на Kanban, в планировщике и из Telegram. Открывайте любого CLI-агента живой вкладкой терминала, переживающей перезапуск. Плюс аудит Telegram: больше не теряются ответы в удалённой теме, не ломаются блоки кода в длинных ответах и не дублируется промпт.
